...
const friendsRoutes = [
  {
    ...
    description: "List of all people you are currently friends with.",
  },
  {
    url: "/friends/pending",
    name: "Pending",
...
export function SecondarySidebar({ path }: SecondarySidebarProps) {
  const [mails] = useState(data.mails);
